...
export default function Main() {
  ...
  const commonButtonStyle = {
    fontSize: '2rem', // 2 times the default font size
    padding: '10px 20px',
    borderRadius: '5px',
    backgroundColor: '#576618', // Changed the button color to a more distinct color
    color: 'white',
    textDecoration: 'none',
    cursor: 'pointer',
  ...
  const mainContainerStyle = {
    ...
    marginTop: '10px', // Move the entire content up by 10 pixels
  };
